...
public class CustomerDao extends Dao {
	...
	public void update(Customer customer) throws SQLException {
		...
		boolean result = execute(sqlString, customer.getId(), sqlString, customer.getFirstName(), customer.getLastName(), customer.getStreet(), customer.getCity(),
				customer.getPostalCode(), customer.getPhone(), customer.getEmailAddress(), toTimestamp(customer.getJoinedDate()));
